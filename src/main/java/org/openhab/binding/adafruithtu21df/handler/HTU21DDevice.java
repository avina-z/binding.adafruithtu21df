...
public class HTU21DDevice extends I2CRpi {
    ...
    public float readHumidity() {
         ...
         * checksum = 0x6B;
         */
        short rawHumidity = (short) ((msb << 8) | lsb);
    ...
    public float readTemperature() {
        ...
        // lsb = 0x3A;
        // checksum = 0x7C;
        short rawTemperature = (short) ((msb << 8) | lsb);
    ...
    private long SHIFTED_DIVISOR = 0x988000; // This is the 0x0131 polynomial shifted to farthest left of three bytes
    ...
    private long check_crc(short message_from_sensor, short check_value_from_sensor) {
        ...
        for (int i = 0; i < 16; i++) // Operate on only 16 positions of max 24. The remaining 8 are our remainder and
                                     // should be zero when we're done.
        {
